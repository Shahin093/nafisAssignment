...
const Navbar = () => {
    return (
        <div>
            <nav class=" bg-purple-600 w-full flex relative justify-between items-center mx-auto px-8 h-20">
                            ...
                            <button class="flex items-center flex-grow-0 flex-shrink pl-2 relative w-60 border rounded-full px-1  py-1" type="button">
                                ...
                                <div class="flex items-center justify-center relative  h-8 w-8 rounded-full">
                                    <svg
                                        ...
                                        style=
                                        {{
                                            display: 'block', fill: 'none', height: "12px", stroke: 'currentcolor', strokeWidth: '5.33333', overflow: 'visible'
                                        }}
                                    >
                                        <g fill="none">
                                            <path
                ...
                <div class="flex-initial">
                    <div class="flex justify-end items-center relative">
                        ...
                        <div class="flex mr-4 items-center">
                            ...
                            <a class="inline-block py-2 px-3 hover:bg-gray-200 rounded-full" href="#">
                                <div class="flex items-center relative cursor-pointer whitespace-nowrap">Blogs</div>
                            </a>
                            <a class="inline-block py-2 px-3 hover:bg-gray-200 rounded-full" href="#">
                            ...
                            <div class="block relative">
                                <button type="button" class="inline-block py-2 px-3 hover:bg-gray-200 rounded-full relative ">
                                    <div class="flex items-center h-5">
                                        <div class="_xpkakx">
                                            <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style=
                                                {{
